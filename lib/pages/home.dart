...
class _HomeState extends State<Home> {
  ...
  List<CipherInfo> ciphers = [
    ...
    CipherInfo(
      ...
      encode: PolluxManager.encode,
      getEncodeCiphertext: PolluxManager.getEncodingCiphertext,
      encodeReady: PolluxManager.encodeReady,
      clearEncodingVariables: PolluxManager.clearEncodingVariables,
    ),
    CipherInfo(
      name: 'Morbit', 
      ...
      encode: MorbitManager.encode,
      getEncodeCiphertext: MorbitManager.getEncodingCiphertext,
      encodeReady: MorbitManager.encodeReady,
      clearEncodingVariables: MorbitManager.clearEncodingVariables,
    ),
    CipherInfo(
      name: 'Hill', 
